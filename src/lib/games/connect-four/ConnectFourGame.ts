...
CardinalEmojis.Backward;
export enum Emojis {
	Empty = CardinalEmojis.C4Empty,
	PlayerOne = CardinalEmojis.C4PlayerOne,
	PlayerTwo = CardinalEmojis.C4PlayerTwo,
	WinnerOne = CardinalEmojis.C4WinnerOne,
	WinnerTwo = CardinalEmojis.C4WinnerTwo
}
...
export class ConnectFourGame extends BaseReactionGame<number> {
	...
	protected renderOnUpdateOrStart(): string {
		return `(${ConnectFourGame.players[this.turn]}) Turn for ${this.player.name}!\n${this.renderBoard()}`;
	}
