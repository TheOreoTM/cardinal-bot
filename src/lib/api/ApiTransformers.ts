...
function flattenChannel(channel: GuildChannel): FlattenedGuildChannel;
function flattenChannel(channel: NewsChannel): FlattenedNewsChannel;
function flattenChannel(channel: TextChannel): FlattenedTextChannel;
function flattenChannel(channel: VoiceChannel): FlattenedVoiceChannel;
function flattenChannel(channel: DMChannel): FlattenedDMChannel;
function flattenChannel(channel: ThreadChannel): FlattenedThreadChannel;
function flattenChannel(channel: Channel): FlattenedChannel;
function flattenChannel(channel: any): FlattenedChannel {
...
function flattenChannelNews(channel: NewsChannel): FlattenedNewsChannel {
	return {
		id: channel.id,
		type: channel.type as ChannelType.GuildAnnouncement,
